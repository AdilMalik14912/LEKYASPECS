                    ...
                    {!isStaff ? (
                      <nav className="hidden lg:flex items-center space-x-4 xl:space-x-6 text-sm font-medium uppercase tracking-wider text-premium-dark mr-4">
                        ...
                        <div className="relative group py-2">
                          ...
                          <div className="absolute top-full left-0 w-88 min-w-[340px] bg-[#F8F9FA] border border-premium-border/80 rounded-2xl shadow-2xl p-4 hidden group-hover:block z-50 animate-fade-in">
                            {/* About Us Link Header */}
                            <Link href="/about" className="flex items-center gap-3 p-2.5 rounded-xl hover:bg-white transition-all group/item mb-2 border border-transparent hover:border-amber-200 shadow-none hover:shadow-sm">
                              <div className="w-9 h-9 rounded-xl bg-amber-500 text-white flex items-center justify-center font-bold shadow-sm">
                                <Building2 className="w-5 h-5" />
                              </div>
                              <div className="flex-1">
                                <p className="text-xs font-black uppercase tracking-wide text-black group-hover/item:text-premium-accent transition-colors">About Us & Group Vision</p>
                                <p className="text-[10px] font-semibold uppercase tracking-wider text-gray-400">Heritage, Innovation & Corporate Legacy</p>
                              </div>
                              <ArrowRight className="w-4 h-4 text-amber-500 opacity-60 group-hover/item:opacity-100 group-hover/item:translate-x-0.5 transition-all" />
                            </Link>

                            <div className="my-2.5 border-t border-gray-200/80" />

                            {/* Group Companies Section Header */}
                            <div className="text-[11px] font-bold uppercase tracking-wider text-gray-500 px-1 py-1 mb-2 flex items-center justify-between">
                              <span>Group Companies</span>
                              <span className="bg-[#D1FAE5] text-[#065F46] text-[10px] font-bold px-2 py-0.5 rounded-md tracking-wider">Lekya Group</span>
                            </div>
