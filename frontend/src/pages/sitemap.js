      ...
      <div className="bg-premium-light min-h-screen py-16 px-4 sm:px-6 lg:px-8 text-premium-dark font-sans">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm">
            ...
            <div className="border border-premium-accent/20 bg-white/40 backdrop-blur p-6 rounded-lg shadow-sm space-y-4">
              ...
              <div className="flex flex-col gap-2 pt-2">
                <Link href="/shop" className="hover:text-premium-accent transition-colors font-semibold font-semibold">🕶️ Shop Eyewear Catalog</Link>
          ...
          <div className="border border-premium-accent/20 bg-white/20 backdrop-blur p-6 rounded-lg shadow-sm space-y-4 mt-8">
            <h3 className="font-serif text-lg font-bold text-premium-black border-b border-premium-accent/25 pb-2 flex items-center gap-2">
