...
const products = [
  ...
  { name: 'Rose Gold Stella Round', description: 'Beautifully crafted round wireframes made from premium titanium, finished with an elegant rose gold polish. Light as a feather and extremely durable.', price: 4999, category: 'Eyeglasses', gender: 'Women', frame_shape: 'Round', image_urls: JSON.stringify(['https://images.unsplash.com/photo-1577803645773-f96470509666?auto=format&fit=crop&w=600&q=80','https://images.unsplash.com/photo-1508296695146-257a814070b4?auto=format&fit=crop&w=600&q=80']), stock: 30 },
  { name: 'Tortoise Shell Chelsea Cat-Eye', description: 'Make a bold style statement with these hand-polished acetate cat-eye frames in vintage tortoise shell pattern. Ideal for styling up any outfit.', price: 3899, category: 'Eyeglasses', gender: 'Women', frame_shape: 'Cat-Eye', image_urls: JSON.stringify(['https://images.unsplash.com/photo-1508296695146-257a814070b4?auto=format&fit=crop&w=600&q=80','https://images.unsplash.com/photo-1591076482161-42ce6da69f67?auto=format&fit=crop&w=600&q=80']), stock: 25 },
  { name: 'Clear Crystal Wayfarer', description: 'A modern twist on a classic shape. These crystal-clear acetate frames adapt to any face tone, featuring golden metal rivets for a touch of premium luxury.', price: 4200, category: 'Eyeglasses', gender: 'Unisex', frame_shape: 'Wayfarer', image_urls: JSON.stringify(['https://images.unsplash.com/photo-1511499767150-a48a237f0083?auto=format&fit=crop&w=600&q=80','https://images.unsplash.com/photo-1572635196237-14b3f281503f?auto=format&fit=crop&w=600&q=80']), stock: 50 },
  ...
  { name: 'Kids Flexi-Blue blocker', description: 'Indestructible, flexible silicon frames designed specifically for kids. Equipped with zero-power blue light protection lenses for online school classes.', price: 1899, category: 'Eyeglasses', gender: 'Kids', frame_shape: 'Round', image_urls: JSON.stringify(['https://images.unsplash.com/photo-1628157582853-a796fa650a6a?auto=format&fit=crop&w=600&q=80']), stock: 60 },
  ...
  { name: 'Champagne Glass Square', description: 'Warm champagne-hued semi-transparent frames with gradient brown lenses. Provides a sunny, glamorous retro aesthetic for beach trips.', price: 4600, category: 'Sunglasses', gender: 'Women', frame_shape: 'Square', image_urls: JSON.stringify(['https://images.unsplash.com/photo-1502444330042-d1a1ddf9bb5b?auto=format&fit=crop&w=600&q=80']), stock: 20 },
  ...
  { name: 'Kids Aviator Junior', description: 'Retro aviator sunglasses downsized for children. Shatterproof polycarbonate lenses with UV protection and soft-grip temples.', price: 1599, category: 'Sunglasses', gender: 'Kids', frame_shape: 'Aviator', image_urls: JSON.stringify(['https://images.unsplash.com/photo-1503919545889-aef636e10ad4?auto=format&fit=crop&w=600&q=80']), stock: 30 },
  ...
  { name: 'Sterling Rimless Oval', description: 'Premium minimalist oval eyeglasses featuring sterling silver polished wire temples and adjustable silicone nose pads for all-day comfort.', price: 4300, category: 'Eyeglasses', gender: 'Men', frame_shape: 'Oval', image_urls: JSON.stringify(['https://images.unsplash.com/photo-1509695507497-903c140c43b0?auto=format&fit=crop&w=600&q=80']), stock: 20 },
  { name: 'Kids Hero Square Blue-blocker', description: 'Ergonomic, flexible square glasses for kids in bright navy blue. Keeps eyes protected during tablet screen play and desktop studies.', price: 1750, category: 'Eyeglasses', gender: 'Kids', frame_shape: 'Square', image_urls: JSON.stringify(['https://images.unsplash.com/photo-1628157582853-a796fa650a6a?auto=format&fit=crop&w=600&q=80']), stock: 55 },
];
